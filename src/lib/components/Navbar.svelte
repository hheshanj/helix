...
<nav
  class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b {scrolled
    ? 'bg-surface-container/80 backdrop-blur-xl shadow-m3-2 border-outline-variant/20'
    : 'bg-transparent border-transparent'}"
>
  <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
    <!-- Logo -->
    <a href="/" class="flex items-center hover:opacity-80 transition-opacity">
      <img src="/HELIX-nobackground.png" alt="Helix Logo" style="width: 200px; height: auto;" />
    </a>
