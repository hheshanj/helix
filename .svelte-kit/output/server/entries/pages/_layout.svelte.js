...
function Navbar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (theme.isDark) {
      ...
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<svg class="w-5 h-5 text-on-surface-variant" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path></svg>`);
    }
    $$renderer2.push(`<!--]--></button></div> <div class="md:hidden flex items-center gap-1"><button class="p-2 rounded-full hover:bg-surface-container-high transition-colors" aria-label="Toggle theme">`);
    if (theme.isDark) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<svg class="w-5 h-5 text-on-surface" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"></circle><path stroke-linecap="round" d="M12 1v2m0 18v2M4.22 4.22l1.42 1.42m12.72 12.72l1.42 1.42M1 12h2m18 0h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"></path></svg>`);
    } else {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<svg class="w-5 h-5 text-on-surface" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path></svg>`);
    }
    $$renderer2.push(`<!--]--></button> <button class="p-2 rounded-full hover:bg-surface-container-high transition-colors" aria-label="Toggle menu"${attr("aria-expanded", menuOpen)} aria-controls="mobile-menu"><svg class="w-6 h-6 text-on-surface" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">`);
    {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16"></path>`);
    }
