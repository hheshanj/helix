    ...
    try {
      ...
      if (result instanceof Promise) {
        ...
        result.then((transformed) => {
          __privateGet(child, _out).push(`<!--${HYDRATION_START_FAILED}${JSON.stringify(transformed)}-->`);
          failed_snippet(child, transformed, noop);
          __privateGet(child, _out).push(BLOCK_CLOSE);
        });
        child.promise.catch(noop);
      } else {
        __privateGet(child, _out).push(`<!--${HYDRATION_START_FAILED}${JSON.stringify(result)}-->`);
  ...
  for (const item of __privateGet(this, _out)) {
    if (typeof item === "string") {
      ...
      if (__privateGet(item, _boundary)) {
        ...
        try {
          await __privateMethod(_a = item, _Renderer_instances, collect_content_async_fn).call(_a, boundary_content);
          ...
          __privateGet(failed_renderer, _out).push(
          ...
          await __privateMethod(_b = failed_renderer, _Renderer_instances, collect_content_async_fn).call(_b, content);
        }
      } else {
        await __privateMethod(_c = item, _Renderer_instances, collect_content_async_fn).call(_c, content);
      }
    }
  }
  return content;
...
//# sourceMappingURL=chunk-SICCU2IJ.js.map
