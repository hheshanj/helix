...
function create_ownership_validator(props) {
  var _a2, _b, _c;
  const component2 = (_a2 = component_context) == null ? void 0 : _a2.function;
...
function element(node, get_tag, is_svg, render_fn, get_namespace, location) {
  ...
  var filename = dev_fallback_default && location && ((_a2 = component_context) == null ? void 0 : _a2.function[FILENAME]);
  var element2 = null;
...
function is_supported() {
  ...
  if (supported === null) {
    ...
    ((_b = (_a2 = select.firstChild) == null ? void 0 : _a2.firstChild) == null ? void 0 : _b.nodeType) === 1;
  }
  return supported;
}
  ...
  attach(element2, () => () => {
    ...
    const observer = new MutationObserver((entries) => {
      ...
      for (const entry of entries) {
        ...
        selected || (selected = !!((_b = (_a2 = entry.target.parentElement) == null ? void 0 : _a2.closest("option")) == null ? void 0 : _b.selected));
      }
      if (selected) {
...
function validate_binding(binding, blockers, get_object, get_property, line, column) {
  run_after_blockers(blockers, () => {
    var _a2;
    var warned = false;
    var filename = (_a2 = dev_current_component_function) == null ? void 0 : _a2[FILENAME];
    render_effect(() => {
      if (warned) return;
...
//# sourceMappingURL=chunk-7NRLI5RA.js.map
